        ...
        <div class="container is-fluid">
            <div class="navbar-brand">
                <a href="#" class="navbar-item">
                    <img src="{{asset('img/logo.png')}}" width="112" height="28" alt="">
                </a>
            </div>
            <div class="navbar-menu">
                <div class="navbar-start">
                    ...
                    <div class="navbar-item is-icon drop-trigger">
                        <a class="icon-link is-primary is-followers" href="javascript:void(0);">
                                ...
                                <div class="nav-drop-body is-friend-requests">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-content">
                                            ...
                                            <span>Najeel verwick is a common follower </span>
                                        </div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-content">
                                            <a href="#">Dan Walker</a>
                                            <span>You have 4 common followers</span>
                                        </div>
                                        <div class="media-right">
                                            <button class="button icon-button is-solid grey-button raised">
                                                <i data-feather="user-plus"></i>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-content">
                                            <span>You are now followers with <a
                                                    href="#">Nelly Schwartz</a>. Check her <a
                                                    href="#">profile</a>.</span>
                                        </div>
                                        <div class="media-right">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-content">
                                            ...
                                            <span>You have 8 common followers</span>
                                        </div>
                                        <div class="media-right">
                                            <button class="button icon-button is-solid grey-button raised">
                                                <i data-feather="user-plus"></i>
                                    ...
                                    <div class="media">
                                        <figure class="media-left">
                                            <p class="image">
                                                <img src="https://via.placeholder.com/300x300"
                                                     data-demo-src="assets/img/avatars/aline.jpg" alt="">
                                            </p>
                                        </figure>
                                        <div class="media-content">
                                            <span>You are now followers with <a href="#">Elise Walker</a>. Check her <a
                                                    href="#">profile</a>.</span>
                                        </div>
                                        <div class="media-right">
                                            <div class="added-icon">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-content">
                                            <span>You are now followers with <a href="#">Edward Mayers</a>. Check his <a
                                                    href="#">profile</a>.</span>
                                        </div>
                                        <div class="media-right">
                                            <div class="added-icon">
                    ...
                    <div class="navbar-item">
                        <div id="global-search" class="control">
                            ...
                            <div class="search-options">
                                <ul class="options-list">
                                    ...
                                    <li>
                                        ...
                                        <span class="option-description">
                                                ...
                                                <span>Search accross people and followers</span>
                                            </span>
                                    </li>
                                    <!-- Search Option -->
                                    <li>
                                ...
                                <!-- Close -->
                                <div class="is-close">
                                    <button id="close-search-options" type="button" class="button is-solid grey-button">
                                        Close
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="nav-drop is-account-dropdown">
                            <div class="inner">
                                ...
                                <div class="nav-drop-body account-items">
                                    ...
                                    <a class="account-item" href="friends.html">
                                        <div class="media">
                                            <div class="icon-wrap">
                                            ...
                                            <div class="media-content">
                                                <h3>Friends</h3>
                                                <small>Discover Your Friends.</small>
                                            </div>
                                        </div>
                                    </a>
                    ...
                    <div class="inner">
                        ...
                        <div class="nav-drop-body is-friend-requests">
                            ...
                            <div class="media">
                                ...
                                <div class="media-content">
                                    <span>You are now followers with <a href="#">Nelly Schwartz</a>. Check her <a
                                            href="#">profile</a>.</span>
                                </div>
                                <div class="media-right">
                                    <div class="added-icon">
                        ...
                        <div class="nav-drop-body is-friend-requests">
                            ...
                            <div class="media">
                                <figure class="media-left">
                                    <p class="image">
                                        <img src="https://via.placeholder.com/150x150"
                                             data-demo-src="assets/img/avatars/edward.jpg"
                ...
                <div class="columns">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="basic-options" class="compose-options">
                                        ...
                                        <div id="show-activities" class="compose-option">
                                            <img src="{{asset('img/icons/emoji/emoji-1.svg')}}" alt="">
                                            <span>Activity</span>
                                        </div>
                                        <!-- Expand action -->
                                    ...
                                    <div class="more-wrap">
                                        <!-- View more button -->
                                        <button id="show-compose-followers" type="button" class="button is-more"
                                                aria-haspopup="true">
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="card-heading">
                                    ...
                                    <div class="user-block">
                                        ...
                                        <div class="user-info">
                                            <a href="pages-about.html">Dan Walker</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="post-text">
                                        <p>Yesterday with
                                            ...
                                            <a href="#">#Rock'n'Rolla</a> concert in LA. Was totally fantastic! People
                                            were really excited about this one!</p>
                                    </div>
                                    <!-- Featured image -->
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="card-heading">
                                    ...
                                    <div class="user-block">
                                        <div class="image">
                                            <img src="https://via.placeholder.com/300x300"
                                                 data-demo-src="assets/img/avatars/aline.jpg" data-user-popover="5"
                                                 alt="">
                                        </div>
                                        <div class="user-info">
                                            <a href="pages-about.html">Edward Mayers</a>
                                ...
                                <div class="card-body">
                                    <!-- Post body text -->
                                    <div class="post-text">
                                        <p>You all know how i love bootstrap, but i didn't have time to dig deeper into
                                            it. Therefore i found this very
                                    ...
                                    <div class="post-link is-video">
                                        ...
                                        <div class="link-image">
                                            <img src="https://via.placeholder.com/300x300"
                                                 data-demo-src="{{asset('img/demo/video/bootstrap.jpg')}}" alt="">
                                            <div class="video-overlay"></div>
                                            <a class="video-button" data-fancybox
                                               href="https://www.youtube.com/watch?v=N8GksI_-iIM">
                                                <img src="{{asset('img/icons/video/play.svg')}}" alt="">
                                            </a>
                                        </div>
                                        <!-- Link content -->
                                        <div class="link-content">
                                            ...
                                            <p>Before I create the new Bootstrap 4 crash course I want to go over some
                                                of the changes from Bootstrap
                                                3.</p>
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="likers-group">
                                        ...
                                        <img src="https://via.placeholder.com/300x300"
                                             data-demo-src="assets/img/avatars/aline.jpg" data-user-popover="6" alt="">
                                    </div>
                                    <div class="likers-text">
                                        <p>
                                            <a href="#">Daniel</a> and
                                ...
                                <div class="comments-body has-slimscroll">
                                    ...
                                    <div class="media is-comment">
                                        ...
                                        <div class="media-left">
                                            <div class="image">
                                                <img src="https://via.placeholder.com/300x300"
                                                     data-demo-src="assets/img/avatars/aline.jpg" data-user-popover="6"
                                                     alt="">
                                            </div>
                                        </div>
                                        <!-- Content -->
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="card-heading">
                                    <div class="user-block">
                                        ...
                                        <div class="user-info">
                                            <a href="pages-about.html">Elise Walker</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="post-text">
                                        <p>Thanks a lot to
                                            <a href="#">@Gaelle</a> and
                                            <a href="#">@Rolf</a> for this wonderful team lunch. The food was really
                                            tasty and we had some great laughs. Thanks
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="card-heading">
                                    <div class="user-block">
                                        ...
                                        <div class="user-info">
                                            <a href="pages-about.html">Stella Bergmann</a>
                                ...
                                <div class="card-body">
                                    <!-- Post body text -->
                                    <div class="post-text">
                                        <p>Hey followers ! Iam back and i wanted to share with you some awesome pictures
                                            we took during our trip to Santa
                                ...
                                <div class="card-footer">
                                    <div class="media post-comment">
                                        ...
                                        <div class="media-left">
                                            <p class="image is-48x48">
                                                <img src="https://via.placeholder.com/300x300"
                                                     data-demo-src="assets/img/avatars/jenna.png" data-user-popover="8"
                                                     alt="">
                                            </p>
                                        </div>
                                        <!-- Textarea -->
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="card-heading">
                                    ...
                                    <div class="user-block">
                                        ...
                                        <div class="user-info">
                                            <a href="pages-about.html">David Kim</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="post-text">
                                        <p>Just discovered this awesome CSS framework named
                                            <a href="#">#bulmaCss</a>. It's based on flexbox, so easy to use and comes
                                            with so many mobile first modifiers. You
                                    ...
                                    <div class="post-link">
                                        ...
                                        <div class="link-content">
                                            ...
                                            <p>Bulma is a mobile first CSS framework built on top of Flexbox. It's
                                                awesome and so easy to use.</p>
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="card-heading">
                                    ...
                                    <div class="user-block">
                                        ...
                                        <div class="user-info">
                                            <a href="pages-about.html">Bobby Brown</a>
                                            <span class="time">July 26 2018, 11:14am</span>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <!-- Post body text -->
                                    <div class="post-text">
                                        <p>Today, when i was walking back home from my job, i figured that i should
                                            build the best social media template
                                            in ThemeForest. As soon as i got back, i started working on this fresh and
                                            new project. Any suggestions
                            ...
                            <div class="comments-wrap is-hidden">
                                ...
                                <div class="comments-body has-slimscroll">
                                    <div class="comments-placeholder">
                                        <img src="{{asset('img/icons/feed/bubble.svg')}}" alt="">
                    ...
                    <div class="column is-3">
                        ...
                        <div class="card is-birthday-card has-background-image"
                             data-background="{{asset('img/illustrations/cards/birthday-bg.svg')}}">
                            <div class="card-heading">
                        ...
                        <div class="card">
                                            ...
                                            <a href="#" class="dropdown-item">
                                                <div class="media">
                                                    ...
                                                    <div class="media-content">
                                                        ...
                                                        <small>View all follower suggestions.</small>
                                                    </div>
                                                </div>
                                            </a>
                                            <a class="dropdown-item">
                            ...
                            <div class="card-body no-padding">
                                ...
                                <div class="add-friend-block transition-block">
                                    ...
                                    <div class="add-follower add-transition">
                                        <i data-feather="user-plus"></i>
                                    </div>
                                </div>
                                <!-- Suggested follower -->
                        ...
                        <div class="card is-new-job-card has-background-image"
                             data-background="{{asset('img/illustrations/cards/job-bg.svg')}}">
                            <div class="card-heading">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body no-padding">
                                ...
                                <div class="page-block transition-block">
                                    <img src="https://via.placeholder.com/300x300"
                                         data-demo-src="assets/img/icons/logos/fastpizza.svg" data-page-popover="0"
                                         alt="">
                                    <div class="page-meta">
                                ...
                                <div class="page-block transition-block">
                                    <img src="https://via.placeholder.com/300x300"
                                         data-demo-src="assets/img/icons/logos/metamovies.svg" data-page-popover="2"
                                         alt="">
                                    <div class="page-meta">
                                ...
                                <div class="page-block transition-block">
                                    <img src="https://via.placeholder.com/300x300"
                                         data-demo-src="assets/img/icons/logos/nuclearjs.svg" data-page-popover="3"
                                         alt="">
                                    <div class="page-meta">
                                        <span>Nuclearjs</span>
                                        <span>Technology</span>
                        ...
                        <div class="card is-ad">
                            <div class="card-body">
                                <img src="{{asset('img/ads/ninja-ad.svg')}}" alt="">
                                <div class="ad-text">
                        ...
                        <div id="latest-activity-1" class="card">
                            ...
                            <div class="card-body no-padding">
                                ...
                                <div class="page-block">
                                    <img src="https://via.placeholder.com/300x300"
                                         data-demo-src="assets/img/avatars/hanzo.svg" data-page-popover="5" alt="">
                                    <div class="page-meta">
                                        <span>Css Ninja</span>
                        ...
                        <div class="inner">
                            <div class="left-section">
                                <div class="search-subheader">
                                    <div class="control">
                                        <input type="text" class="input" placeholder="Search for followers to add">
                                        <span class="icon">
                                                <i data-feather="search"></i>
                                            </span>
                                    </div>
                            ...
                            <div class="right-section has-slimscroll">
                                <div class="selected-count">
                                    <span>Selected</span>
                                    <span id="selected-followers-count">0</span>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="content-block is-active">
                            <img src="{{asset('img/illustrations/cards/albums.svg')}}" alt="">
                            <div class="help-text">
                        ...
                        <div class="content-block">
                            <img src="{{asset('img/illustrations/cards/upload.svg')}}" alt="">
                            <div class="help-text">
                    ...
                    <div class="card-body">
                        <div class="left-section">
                            ...
                            <div id="tagged-in-album" class="tagged-in-album">
                                <div class="head">
                                    <h4>Tag followers in this album</h4>
                                    <button type="button" class="button is-solid dark-grey-button icon-button">
                                        <i data-feather="plus"></i>
                                    </button>
                                </div>

                                <p>You can tag followers in this album. Tagged followers can only see the photos they
                                    are tagged in.</p>
                                <div class="field is-autocomplete is-hidden">
                                    <div class="control">
                                        <input id="create-album-followers-autocpl" type="text"
                                               class="input is-sm is-fade" placeholder="Search for followers">
                                        <div class="icon">
                                            <i data-feather="search"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="shared-album">
                                <div class="head">
                                    <h4>Allow followers to add photos</h4>
                                ...
                                <p>If you enable this feature, your tagged followers will be able to share content
                                    inside this album.</p>
                            </div>
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a class="dropdown-item">
                                        <div class="media">
                                            ...
                                            <div class="media-content">
                                                <h3>followers</h3>
                                                <small>only followers can see this publication.</small>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="dropdown-item">
                                        <div class="media">
                                            ...
                                            <div class="media-content">
                                                <h3>Specific followers</h3>
                                                <small>Don't show it to some followers.</small>
                                            </div>
                                        </div>
                                    </a>
                                    <hr class="dropdown-divider">
        ...
        <div id="videos-help-modal" class="modal videos-help-modal is-xsmall has-light-bg">
            ...
            <div class="modal-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="content-block is-active">
                            <img src="{{asset('img/illustrations/cards/videotrip.svg')}}" alt="">
                            <div class="help-text">
                        ...
                        <div class="content-block">
                            <img src="{{asset('img/illustrations/cards/videocall.svg')}}" alt="">
                            <div class="help-text">
                                    ...
                                    <div class="dropdown is-accent page-dropdown">
                                        <div>
                                            <div class="button page-selector">
                                                <img src="https://via.placeholder.com/150x150"
                                                     data-demo-src="assets/img/avatars/hanzo.svg" alt=""> <span>Css Ninja</span>
                                                <i
                                                    data-feather="chevron-down"></i>
                                            </div>
                                        </div>
                            ...
                            <div class="publication-meta">
                                <div class="inner-flex">
                                    <img id="share-modal-avatar" src="https://via.placeholder.com/300x300"
                                         data-demo-src="assets/img/avatars/dan.jpg"
                                         data-user-popover="1" alt="">
                                    <p id="share-modal-text">Yesterday with <a href="#">@Karen Miller</a> and <a
                                            href="#">@Marvin Stemperd</a> at the
                ...
                <div class="card">
                    ...
                    <div class="card-body has-text-centered">
                        ...
                        <div class="image-wrap">
                            <img src="{{asset('img/illustrations/characters/no-stream.svg')}}" alt="">
                        </div>

                        <h3>Streaming Disabled</h3>
                        <p>Streaming is not allowed from mobile web. Please use our mobile apps for mobile
                            streaming.</p>
        ...
        <div class="chat-inner">
            ...
            <div id="chat-body" class="chat-body is-opened">
                ...
                <div id="elise-conversation" class="chat-body-inner has-slimscroll is-hidden">
                    ...
                    <div class="chat-message is-received">
                        <img src="https://via.placeholder.com/300x300" data-demo-src="assets/img/avatars/aline.jpg"
                             alt="">
                        <div class="message-block">
                            <span>12:19pm</span>
        ...
        <div class="modal-content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <img src="{{asset('img/icons/chat/bubbles.svg')}}" alt="">
        ...
        <div class="modal-content">
            ...
            <div class="card">
                ...
                <div class="card-body has-text-centered">
                    ...
                    <p>Thanks for taking the friendkit tour. There are still tons of other features for you to
                        discover!</p>
