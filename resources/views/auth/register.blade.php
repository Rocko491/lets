        ...
        <div class="signup-wrapper">
            ...
            <div class="outer-panel">
                <div class="outer-panel-inner">
                    ...
                    <form id="register_form" method="POST" role="form" action="{{ route('register') }}">
                        @csrf
                        <div id="signup-panel-2" class="form-group process-panel-wrap is-narrow">
                            <div class="form-panel">
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input id="first_name" type="text" class="input form-control" name="first_name"
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input id="last_name" type="text" class="input form-control" name="last_name"
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input id="profile_name" type="text" class="input form-control"
                                               name="profile_name"
                                               value="" required placeholder="Enter your profile name">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>Parent's Name</label>
                                    <div class="control">
                                        <input id="parent_name" type="text" class="input form-control"
                                               name="parent_name"
                                               value="" placeholder="Enter your parent's name">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>Email</label>
                            ...
                            <div class="form-panel">
                                <div class="field field-group">
                                    ...
                                    <div class="control has-icon">
                                        <input id="city" type="text" class="input is-fade form-control" name="city"
                                               value=""
                                ...
                                <div class="field field-group">
                                    <label>State</label>
                                    <div class="control has-icon">
                                        <input id="state" type="text" class="input is-fade form-control" name="state"
                                ...
                                <div class="field field-group is-autocomplete">
                                    ...
                                    <div class="control has-icon">
                                        <input id="district" type="text" class="input is-fade form-control"
                                               name="district"
                                               value="" placeholder="Enter District">
                                        <div class="form-icon">
                                ...
                                <div class="field field-group is-autocomplete">
                                    <label>Country</label>
                                    <div class="control has-icon">
                                        <input id="country" type="text" class="input is-fade form-control"
                                               name="country"
                                ...
                                <div class="field">
                                    <label>Address</label>
                                    <div class="control">
                                    <textarea id="address" type="text" name="address" class="textarea is-fade" rows="2"
                                              placeholder="Fill in your address..."
                                              style="margin-top: 0px; margin-bottom: 0px; height: 59px;"></textarea>
                                    </div>
                                </div>
                        ...
                        <div id="signup-panel-4" class="form-group process-panel-wrap is-narrow">
                            <div class="form-panel">
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input id="password" type="password" class="input form-control" name="password"
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input id="confirm_password" type="password" class="input form-control" required
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input id="phone" type="number" class="input form-control" name="phone" required
                        ...
                        <div id="signup-panel-5" class="form-group process-panel-wrap is-narrow">
                            <div class="form-panel">
                                <img class="success-image" src="{{ asset('img/illustrations/signup/mailbox.svg') }}"
                                     alt="">
